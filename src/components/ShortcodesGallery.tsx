    ...
    <div className="space-y-12">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-8 text-slate-100 shadow-2xl space-y-3">
        <div className="flex items-center gap-2 text-emerald-400 text-xs font-semibold uppercase tracking-wider">
          ...
          Moteur 50+ Widgets & Shortcodes Elementor
        </div>
        <h2 className="text-3xl font-bold text-white tracking-tight">
          Bibliothèque de Composants & Widgets Immobiliers
        </h2>
        <p className="text-xs sm:text-sm text-slate-400 max-w-2xl leading-relaxed">
          Intégrez facilement des grilles de villes, calculateurs de prêt, carrousels d'agents, compteurs de statistiques et blocs de champs personnalisés dans vos pages.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            ...
            Widget 3: Module Dynamic Fields Builder
          </h3>
          <button
          ...
          >
            <SlidersHorizontal className="w-3.5 h-3.5" /> Gérer dans Fields Builder
          </button>
        </div>
